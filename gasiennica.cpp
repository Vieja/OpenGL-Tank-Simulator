...
#define gasiennica "modele/gasiennicav3.obj"

using namespace glm;

Gasiennica::Gasiennica(vec3 starter) {
    bool res = loadOBJ(gasiennica, this->vertices, this->uvs, this->normals, this->vCount);
    if(!res) {
...
void Gasiennica::drawSolid(GLuint &tex,mat4 &V) {
